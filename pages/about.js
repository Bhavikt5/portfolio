    ...
    <section className={styles.about}>
      ...
      <div className={styles.outerBox}>
        <div className={styles.content}>
          <p>
            Hello everyone, my name is Bhavik Tank, and I am a self-taught web
            developer. I began my journey as a web developer at the age of 30,
            ...
            hours learning and practicing my skills, and I am proud to say that
          ...
          <p>
            ...
            front-end development, including HTML, CSS, JavaScript and JQuery as
            well as back-end development, including NodeJS. I am also
            well-versed in web development frameworks ReactJS and NextJS.
          </p>
